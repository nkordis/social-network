...
<c:set var="profilePhoto" value="/profilephoto/${userId}" />
<c:set var="editProfileAbout" value="/edit-profile-about" />
<c:set var="saveInterest" value="/save-interest" />
<c:set var="deleteInterest" value="/delete-interest" />
	...
	<div class="col-md-10 col-md-offset-1">
		...
		<div class="profile-about">
			<div class="profile-image">
				<div class="profile-image">
					<img alt="image_avatar" id="profilePhotoImage"
						src="${profilePhoto}">
				</div>
			...
			<div class="profile-text">
				<c:choose>
					<c:when test="${profile.about == null}">Click 'edit' to add information about yourself.</c:when>
					<c:otherwise>
						${profile.about}
					</c:otherwise>
				</c:choose>
